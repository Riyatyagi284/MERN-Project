        ...
        <>
            ...
            <div className="dashboard">
                ...
                <div className="newProductContainer">
                    {loading ? <Loader /> : (
                        <>
                            <div className="confirmOrderPage" style={{ display: ProcessOrder.orderStatus === "Delivered" ? "block" : "grid" }}>
                                ...
                                <div>
                                    <div className="confirmshippingArea">
                                        ...
                                        <div className="orderDetailsContainerBox">
                                            ...
                                            <div>
                                                <p>Address:</p>
                                                <span>{order.shippingInfo && `${order.shippingInfo.address}, ${order.shippingInfo.city}, ${order.shippingInfo.state}, ${order.shippingInfo.state}, ${order.shippingInfo.pincode}, ${order.shippingInfo.country}`}</span>
                                            </div>
