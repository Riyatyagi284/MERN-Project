...
// import { clearErrors, login, register } from "../../actions"
// import toast
...
const { error, loading, isAuthenticated } = useSelector((state) => state.uesr);
...
// ye wala smjh nhi aaya mughe (why we are using this function and where we are using it.)
...
}, [dispatch, error, toast, history , isAuthenticatedd, redirect])
